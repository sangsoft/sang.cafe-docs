'use strict';(function(){const searchDataURL='/en.search-data.min.e97ad40df555aec76977a76362a043e7863be82b09f146db949b0a1d027574b0.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
